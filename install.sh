...
install_XrayR() {
    ...
    file="https://raw.githubusercontent.com/chaomynhan/xray123/main/XrayR.service"
    ...
    curl -o /usr/bin/XrayR -Ls https://raw.githubusercontent.com/chaomynhan/xray123/main/XrayR.sh
